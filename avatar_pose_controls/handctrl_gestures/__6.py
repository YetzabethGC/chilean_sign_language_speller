...
import sys
sys.path.append("/home/vpoblete/yetzabethg/New Folder/avatar/codigos/") #DIRECTORIO CON CÓDIGOS DE CONTROL
...
hc.rhF(0,0,6,6,6)   #CONTROL DEDOS(1=PULGAR, 2=INDICE, 3=MEDIO, 4=ANULAR, 5=MEÑIQUE) VALORES DEL 0(ABIERTO) A 6(CERRADO)
detRF(1,1,0)
detRF(2,0,0)
detRF(4,-1,0)
detRF(5,-1,0)
